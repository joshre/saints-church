...
<div class="relative bg-wallpaper dark:bg-wallpaper-dark">
  ...
  <main itemscope itemtype="https://schema.org/CollectionPage" tabindex="-1" id="main-content" class="relative">
    ...
    <div class="mx-auto max-w-4xl text-center">
      <h1 itemprop="name headline" class="mb-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl dark:text-white font-display child" style="text-shadow: 0 1px 3px rgba(0,0,0,0.12), 0 4px 12px rgba(0,0,0,0.06); letter-spacing: -0.02em;">
        {{ site.data.content.sermons.title }}
      </h1>

      {% if site.data.content.sermons.subtitle %}
        <p role="doc-subtitle" itemprop="alternativeHeadline" class="mb-10 text-lg sm:text-xl text-white/50 child [--delay:0.15s] dark:text-stone-400" style="text-shadow: 0 1px 2px rgba(0,0,0,0.06); letter-spacing: 0.01em;">
        ...
        <div class="relative p-7 bg-white lg:p-10 rounded-[2rem] shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)] child [--delay:0.15s] dark:bg-stone-900 dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)] dark:before:pointer-events-none dark:before:absolute dark:before:-inset-px dark:before:rounded-[2rem] dark:before:shadow-[0px_2px_8px_0px_rgba(0,0,0,0.20),0px_1px_0px_rgba(255,255,255,0.06)_inset]">
          <div class="grid grid-cols-1 gap-6 items-start lg:gap-8 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2">
              <header class="mb-6">
                <!-- Latest Badge -->
                <div class="inline-flex gap-x-1.5 items-center py-1 px-2.5 mb-3 text-xs font-medium tracking-wide rounded-full border forced-colors:outline bg-saints-500/10 text-saints-700 border-saints-500/15 dark:bg-saints-400/10 dark:text-saints-300 dark:border-saints-400/15">
                  Latest Sermon
                </div>
                ...
                {% if latest_sermon.date %}
                  <p class="text-base font-medium text-saints-600 dark:text-saints-400">
              ...
              {% if latest_sermon.description %}
                <div class="mb-5 max-w-none prose prose-stone dark:prose-invert">
            ...
            <!-- Metadata Sidebar -->
            <div class="lg:col-span-1 lg:pl-8 lg:border-l lg:border-stone-100/70 dark:lg:border-stone-800/70">
              <div class="space-y-6">
                <!-- Preacher -->
                {% if latest_sermon.pastor %}
                  <div>
                    <dt class="mb-2.5 font-medium uppercase text-saints-600 font-display text-[0.6rem] tracking-[0.08em] dark:text-stone-400">Preacher</dt>
                ...
                <div class="space-y-4">
                  <div>
                    <dt class="mb-1 font-medium uppercase text-saints-600 font-display text-[0.6rem] tracking-[0.08em] dark:text-stone-400">Scripture</dt>
                    <dd>
                  ...
                  {% if latest_sermon.duration %}
                    <div>
                      <dt class="mb-1 font-medium uppercase text-saints-600 font-display text-[0.6rem] tracking-[0.08em] dark:text-stone-400">Duration</dt>
                      <dd>
                  ...
                  {% if latest_sermon.series %}
                    <div>
                      <dt class="mb-1 font-medium uppercase text-saints-600 font-display text-[0.6rem] tracking-[0.08em] dark:text-stone-400">Series</dt>
                      <dd>
    ...
    <div class="relative">
      ...
      <div class="px-6 mx-auto max-w-7xl lg:px-8">
        <div class="mb-12 text-center">
          <p class="mb-4 text-xs font-medium uppercase tracking-[0.2em] text-white/30 font-display">Browse All</p>
          <div class="flex gap-4 justify-center items-center mb-0">
            <span class="block w-16 h-px bg-white/15"></span>
        ...
        {% if archive_sermons.size > 12 %}
          <div class="mt-10 text-center">
            <output role="status" aria-live="polite" class="block mb-4 text-sm text-white/50 dark:text-stone-400" id="sermon-count">
    ...
    {% endif %}
      ...
      <!-- CTA Section -->
      <aside aria-labelledby="cta-section" class="relative pt-14 pb-14 animate-children">
        <div class="px-6 mx-auto max-w-3xl text-center lg:px-8">
          <div class="child">
            <h2 id="cta-section" class="mb-4 text-2xl font-semibold sm:text-3xl text-white/85 font-display" style="text-shadow: 0 1px 2px rgba(0,0,0,0.1);">
