...
data_key: beliefs
content_width: wide
prose_class: "prose prose-lg prose-stone dark:prose-invert max-w-none [&>h2]:scroll-mt-16 [&>h2]:font-display [&>h2]:text-2xl [&>h2]:font-semibold [&>h2]:tracking-tight [&>h2]:text-stone-900 [&>h2]:dark:text-white [&>h2]:border-l-4 [&>h2]:border-saints-400/30 [&>h2]:dark:border-saints-700/30 [&>h2]:pl-6 [&>h2]:py-2 [&>h2]:my-12 [&>h2]:bg-saints-100/5 [&>h2]:dark:bg-saints-900/8 [&>h2]:rounded-r-lg [&>h3]:font-display [&>h3]:text-xl [&>h3]:font-semibold [&>h3]:tracking-tight [&>h3]:text-stone-900 [&>h3]:dark:text-white [&>h3]:mt-10 [&>h3]:mb-5 [&>h3]:border-l-2 [&>h3]:border-saints-400/18 [&>h3]:dark:border-saints-700/18 [&>h3]:pl-4 [&>h3]:py-0.5 [&>p]:text-stone-600 [&>p]:dark:text-stone-400 [&>p]:leading-relaxed [&>p:first-child]:text-stone-700 [&>p:first-child]:dark:text-stone-300"
---