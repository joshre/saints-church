(() => {
  ...
  function Io(e) {
    if (!e)
      return 0;
    let o = X.get(document) || new Set(), t = q.get(document) || new Set();
  ...
  function Ve(e) {
    let o, t = q.get(e) || new Set(), n = X.get(e) || new Set(), r = t.size > 0 ? t : n.size > 0 ? n : null;
  ...
  function Ho(e) {
    for (; e; ) {
      if (e instanceof HTMLElement && e.popover === "auto" && xe.get(e) === "showing")
        return e;
      if (e = e instanceof Element && e.assignedSlot || e.parentElement || Te(e), e instanceof Nt && (e = e.host), e instanceof Document)
        return;
    }
  }
  function Hn(e) {
    for (; e; ) {
      ...
      if (o instanceof HTMLElement)
        return o;
      if (e = e.parentElement || Te(e), e instanceof Nt && (e = e.host), e instanceof Document)
        return;
    }
  }
  function Po(e, o) {
  ...
  function Rt(e) {
    ...
    if (!e.dispatchEvent(new at("beforetoggle", {cancelable: true, oldState: "closed", newState: "open"})) || !pe(e, false))
      return;
    let t = false, n = e.popover, r = null, i = Po(e, X.get(o) || new Set()), s = Po(e, q.get(o) || new Set());
    if (n === "auto" && (Bt(q.get(o) || new Set(), t, true), me(i || o, t, true), r = "auto"), n === "hint" && (s ? (me(s, t, true), r = "hint") : (Bt(q.get(o) || new Set(), t, true), i ? (me(i, t, true), r = "auto") : r = "hint")), n === "auto" || n === "hint") {
      if (n !== e.popover || !pe(e, false))
        return;
      Ve(o) || (t = true), r === "auto" ? (X.has(o) || X.set(o, new Set()), X.get(o).add(e)) : r === "hint" && (q.has(o) || q.set(o, new Set()), q.get(o).add(e));
    }
    lt.delete(e);
    let a = o.activeElement;
    e.classList.add(":popover-open"), xe.set(e, "showing"), rt.has(o) || rt.set(o, new Set()), rt.get(o).add(e), Ro(st.get(e), true), Nn(e), t && a && e.popover === "auto" && lt.set(e, a), Mo(e, "closed", "open");
  }
  function Se(e, o = false, t = false) {
    ...
    if (["auto", "hint"].includes(e.popover) && (me(e, o, t), !pe(e, true)))
      return;
    let s = X.get(i) || new Set(), a = s.has(e) && qe(s) === e;
    if (Ro(st.get(e), false), st.delete(e), t && (e.dispatchEvent(new at("beforetoggle", {oldState: "open", newState: "closed"})), a && qe(s) !== e && me(e, o, t), !pe(e, true)))
      return;
  ...
  function me(e, o, t) {
    ...
    Bt(q.get(i) || new Set(), o, t), (r = X.get(i)) != null && r.has(e) && Co(e, X.get(i), o, t);
  }
  function Oo(e) {
    if (!e.isTrusted)
      return;
...
`;
  ...
  function Ht(e) {
    ...
    if (Ae === false) {
      ...
      e.adoptedStyleSheets = [Ae, ...e.adoptedStyleSheets];
  }
  function No() {
    if (typeof window > "u")
      return;
    ...
    let i = (l) => {
      ...
      if (!(g instanceof Element) || g?.shadowRoot)
        return;
      let m = Te(g);
      if (!(m instanceof Do || m instanceof Document))
        return;
      let c = u.find((b) => {
        var f;
  ...
  function qo() {
    ...
    function a(f) {
      Object.defineProperties(f.prototype, {commandForElement: {enumerable: true, configurable: true, set(h) {
        ...
        let h = s.get(this);
        if (h)
          return h.isConnected ? h : (s.delete(this), null);
    ...
    function u(f) {
      for (let h of f)
        h.oncommand = new Function("event", h.getAttribute("oncommand"));
    }
    ...
    function m(f) {
      if (f.defaultPrevented || f.type !== "click")
        return;
      let h = f.target.closest("button[invoketarget], button[invokeaction], input[invoketarget], input[invokeaction]");
      if (h && (console.warn("Elements with `invoketarget` or `invokeaction` are deprecated and should be renamed to use `commandfor` and `command` respectively"), h.matches("input")))
        throw new Error("Input elements no longer support `commandfor`");
      let p = f.target.closest("button[commandfor], button[command]");
      if (!p)
        return;
      if (p.form && p.getAttribute("type") !== "button")
        throw f.preventDefault(), new Error("Element with `commandFor` is a form participant. It should explicitly set `type=button` in order for `commandFor` to work. In order for it to act as a Submit button, it must not have command or commandfor attributes");
      ...
      if (v.dispatchEvent(y), y.defaultPrevented)
        return;
  ...
  function Me(e, o, t, n, r, i) {
    ...
    let u = t();
    for (let c of u)
      c.setAttribute("type", "button"), c.setAttribute("aria-haspopup", "true"), c.setAttribute("aria-controls", e.id), c.setAttribute("aria-expanded", "false");
  ...
  function Or(e, o, t) {
    ...
    document.addEventListener("pointerdown", (r) => {
      ...
      if (r.target === e) {
        ...
        if (s >= l.left && s <= l.right && a >= l.top && a <= l.bottom)
          return;
        t(r);
        return;
      }
  ...
  function Lt(e, o, t) {
    ...
    function u() {
      ...
      for (let S of w)
        l.has(S) || (l.add(S), S.id || (S.id = P("item")), S.setAttribute("role", k), S.setAttribute("tabIndex", "-1"), S.addEventListener("click", () => o.onItemClick(S), E), ue(S, "mouseover", t, () => f(S, false)), ue(S, "mouseout", t, () => h()));
    }
    u();
    ...
    a.addEventListener("pointerdown", (w) => {
      ...
      if (w.button !== 0 || a.matches(":disabled") || !e.hasAttribute("open"))
        return;
      if (Date.now() - (m ?? 0) > Mr) {
    ...
    function v(w, E = false) {
      ...
      if (!E && $ && re !== -1 && B($) && ($.textContent?.trim().toLowerCase() || "").startsWith(S))
        return $;
      for (let D = re + 1; D < k.length; D++)
        if ((k[D].textContent?.trim().toLowerCase() || "").startsWith(S) && B(k[D]))
          return k[D];
      for (let D = 0; D <= re; D++)
        if ((k[D].textContent?.trim().toLowerCase() || "").startsWith(S) && B(k[D]))
          return k[D];
  ...
  var Pn, So, Cn, M, Ot, d, L, I, H, at, Lo, Nt, On, rt, X, q, xe, st, lt, Dt, Mt, Do, qn, Ae, ct, Ie, We, se, A, Pe, Z, _e, Ke, K, Un, jn, zn, $o, _o, Gn, Yn, Yo, Qo, Xo, Jn, Zn, er, tr, or, nr, rr, ir, fr, br, Gt, pn, mn, hn, yn, ae, N, Ye, Xt, Jt, En, Tr, Sr, Zt, xn, wt, Tn, Sn, F, Qe, eo, G, Xe, Je, te, xt, no, oo, ro, io, so, lo, ao, He, Q, oe, Be, ye, Ze, uo, Re, co, fo, Ne, et, po, Tt, Mr, ne, Ee, C, ot, mo, tt, ho, go, O, It, kt, bo, vo, Pt, wo, yo, Eo, Ao;
  var init_dist = __esm({
    "node_modules/@tailwindplus/elements/dist/index.js"() {
      ...
      Cn = (e, o, t) => o in e ? Pn(e, o, {enumerable: true, configurable: true, writable: true, value: t}) : e[o] = t;
      M = (e, o, t) => Cn(e, typeof o != "symbol" ? o + "" : o, t);
      Ot = (e, o, t) => o.has(e) || So("Cannot " + t);
      d = (e, o, t) => (Ot(e, o, "read from private field"), t ? t.call(e) : o.get(e));
      L = (e, o, t) => o.has(e) ? So("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, t);
      I = (e, o, t, n) => (Ot(e, o, "write to private field"), n ? n.call(e, t) : o.set(e, t), t);
      H = (e, o, t) => (Ot(e, o, "access private method"), t);
      if (typeof globalThis.window < "u") {
        ...
        document.addEventListener("submit", (o) => {
          ...
          if (t && t.method === "dialog") {
            ...
            if (i === true || (o.preventDefault(), o.stopImmediatePropagation(), i === false))
              return;
            i.then((s) => {
      ...
      Lo = new WeakMap();
      Nt = globalThis.ShadowRoot || function() {
      };
      ...
      Dt = new WeakMap();
      Mt = new WeakMap();
      Do = globalThis.ShadowRoot || function() {
      };
      qn = /(^|[^\\]):popover-open\b/g;
      Ae = null;
      typeof globalThis.window < "u" && (Bo() || (No(), ut(async () => {
        if (await $n("popover-polyfill"))
          return;
      ...
      A = class extends HTMLElement {
        ...
        connectedCallback() {
          if ("observedAttributes" in this.constructor && typeof this.constructor.observedAttributes == "object" && Array.isArray(this.constructor.observedAttributes))
            for (let n of this.constructor.observedAttributes)
              typeof n == "string" && (n in this || Object.defineProperty(this, n, {get() {
      ...
      Qo = function(e) {
        return e === void 0 && (e = {}), {name: "flip", options: e, async fn(o) {
          ...
          if (D = [...D, {placement: r, overflows: re}], !re.every((ce) => ce <= 0)) {
            ...
            if (Ct && (!(m === "alignment" ? y !== le(Ct) : false) || D.every((_) => le(_.placement) === y ? _.overflows[0] > 0 : true)))
              return {data: {index: ce, overflows: D}, reset: {placement: Ct}};
      ...
      Jn = new Set(["inline", "contents"]);
      Zn = new Set(["table", "td", "th"]);
      er = [":popover-open", ":modal"];
      tr = ["transform", "translate", "scale", "rotate", "perspective"];
      or = ["transform", "translate", "scale", "rotate", "perspective", "filter"];
      nr = ["paint", "layout", "strict", "content"];
      rr = new Set(["html", "body", "#document"]);
      ir = K(0);
      fr = new Set(["absolute", "fixed"]);
      br = async function(e) {
      ...
      Gt = {convertOffsetParentRelativeRectToViewportRelativeRect: lr, getDocumentElement: U, getClippingRect: mr, getOffsetParent: cn, getElementRects: br, getClientRects: ar, getDimensions: hr, getScale: De, isElement: V, isRTL: vr};
      pn = Xo;
      mn = Qo;
      hn = (e, o, t) => {
        let n = new Map(), r = {platform: Gt, ...t}, i = {...r.platform, _c: n};
        return Yo(e, o, {...r, platform: i});
      };
      yn = {get selectRequired() {
        let e = document.createElement("select");
        e.setAttribute("required", "true");
        let o = e.validationMessage;
        return Object.defineProperty(this, "selectRequired", {value: o}), o;
      }};
      ae = ["[contentEditable=true]", "[tabindex]", "a[href]", "area[href]", "button:not([disabled])", "iframe", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])"].map((e) => `${e}:not([tabindex='-1'])`).join(",");
      N = [];
      ut(() => {
        function e(o) {
          if (o.target === document.body || N[0] === o.target)
            return;
          let t = o.target;
      ...
      eo = class extends A {
        ...
        mount(t) {
          ...
          let s = this, a = new WeakSet();
          function l() {
            for (let c of i.getItems())
              a.has(c) || (a.add(c), c.id || (c.id = P("option")), c.setAttribute("role", "option"), c.setAttribute("aria-selected", "false"), c.setAttribute("tabIndex", "-1"), c.addEventListener("mousedown", (b) => {
      ...
      oo = class extends A {
        ...
        mount(t) {
          ...
          let i = this, s = new WeakSet();
          function a(u = false) {
            var g;
            for (let m of r.getItems())
              s.has(m) || (s.add(m), m.id || (m.id = P("item")), m.setAttribute("role", "option"), m.setAttribute("tabIndex", "-1"), m.setAttribute("aria-selected", "false"), m.hasAttribute("disabled") && m.setAttribute("aria-disabled", "true"), ue(m, "mouseover", t, () => {
                var c;
      ...
      G = new WeakMap(), Xe = new WeakMap(), Je = new WeakMap(), te = new WeakSet(), xt = function(t = false) {
      ...
      Re = class extends A {
        ...
        mount(t) {
          ...
          for (let a of H(this, Ze, uo).call(this))
        ...
        onAttributeChange(t, n, r) {
          switch (t) {
            case "open": {
              ...
              for (let s of H(this, Ze, uo).call(this))
        ...
        beforeClose(t) {
          if (d(this, oe) && (d(this, oe).call(this), I(this, oe, null)), d(this, Q))
            return false;
      ...
      Q = new WeakMap(), oe = new WeakMap(), Be = new WeakMap(), ye = new WeakMap(), Ze = new WeakSet(), uo = function() {
      ...
      Tt = class extends A {
        ...
        mount(t) {
          ...
          for (let r of H(this, et, po).call(this))
            r.setAttribute("aria-expanded", n.toString()), r.setAttribute("aria-controls", this.id);
          this.addEventListener("command", (r) => {
            if (r.target instanceof HTMLElement && "command" in r)
              switch (r.command) {
                case "--show": {
        ...
        onAttributeChange(t, n, r) {
          switch (t) {
            case "hidden": {
              ...
              for (let i of H(this, et, po).call(this))
      ...
      Ne = new WeakMap(), et = new WeakSet(), po = function() {
      ...
      ne = new WeakMap(), Ee = new WeakMap(), C = new WeakMap(), ot = new WeakSet(), mo = function() {
      ...
      O = new WeakMap(), M(It, "observedAttributes", ["anchor", "open"]);
      x("el-menu", It);
      x("el-dropdown", go);
      kt = class extends A {
      ...
      Pt = class extends A {
        mount(o) {
          ...
          for (let a of n)
            a.id || (a.id = P("popover-button")), a.addEventListener("keydown", (l) => {
  ...
  function initMobileNav() {
    ...
    if (!button || !menu || !panel || !menuIcon || !closeIcon)
      return;
    ...
    "js/audio-player.ts"() {
      ...
      SermonPlayer = class {
        constructor(container) {
          ...
          this.scrubberElements = container.querySelectorAll(".audio-scrubber");
  ...
  // js/catechism.ts
  function getMostRecentSundayUTC(date) {
  ...
  function initCatechism() {
    const container = document.getElementById("catechism-questions");
    if (!container)
      return;
    const questionNumber = getCurrentQuestionNumber();
    container.querySelectorAll("[data-catechism]").forEach((item) => {
    ...
    const checkbox = document.getElementById("catechism-mode");
    if (!checkbox)
      return;
  ...
  var MS_PER_WEEK, STORAGE_KEY;
  var init_catechism = __esm({
    "js/catechism.ts"() {
      init_config();
      MS_PER_WEEK = 7 * 24 * 60 * 60 * 1e3;
      STORAGE_KEY = "catechism-mode";
    }
  });
